...
- To Simulate the **MoboBot** on your **dev-PC** follow this [mobo_bot_sim tutorial](https://github.com/robocre8/mobo_bot/blob/humble/MOBO_BOT_SIM_README.md)
...
- to get started with the actual physical **MoboBot** robot (which uses the Raspberry Pi 4), follow this [mobo_bot_base tutorial](https://github.com/robocre8/mobo_bot/blob/humble/MOBO_BOT_BASE_README.md)
